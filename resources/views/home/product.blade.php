        ...
        <div class="grid">
            ...
            <div class="item-rating-filter rounded bg-light">
                <div class="row align-items-center">
                    <div class="col-2">
                        <h2 class="m-0">Rating Filter</h2>
                    </div>
                    <div class="col-3 border-start border-2 ps-5 pe-3">
                    ...
                    <div class="row gy-2">
                        ...
                        <div class="col-12 border rounded p-2 d-flex flex-column bg-light">
                            <div class="d-flex">
                                ...
                                <div class="ms-auto text-end d-flex flex-column">
                                    <div class="d-flex star-review ms-auto text-warning">
                                        <small class="px-2 me-1 border-end  text-dark">
                                            234234 People found this helpful
                                        </small>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor"
                                            class="logo-svg-star-rating">
                                            <path
                        ...
                        <div class="col-12 border rounded p-2 d-flex flex-column bg-light">
                            <div class="d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <small class="text-muted">Reviewed on February 12, 2021</small>
                                </div>
                                <div class="ms-auto text-end d-flex flex-column">
                                    <div class="d-flex star-review ms-auto text-warning">
                                        <small class="px-2 me-1 border-end  text-dark">
                        ...
                        <div class="col-12 border rounded p-2 d-flex flex-column bg-light">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    <div>
                                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum eveniet repellendus
                                        asperiores maxime corrupti facilis nisi. Qui consequatur vero praesentium non maxime
                                        commodi deleniti.
                                    </div>
                                    <div class="mb-2 mt-1 d-flex flex-wrap">
                                        <a href="#">
