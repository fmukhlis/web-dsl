                                            ...
                                            <div class="dropzone p-0 rounded mh-0 overflow-x-o-auto d-flex">
                                                @foreach ($productImages as $productImage)
                                                    <div class="dz-preview my-3 mr-0 ml-3 dz-image-preview">
                                                        <div class="dz-image border border-3">
                                                            <img data-dz-thumbnail alt="nama_file.png"
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="@error('category') is-invalid @enderror form-control custom-select"
                                        ...
                                        <option {{ old('category', $product->category) === 'Lainnya' ? 'selected' : '' }}>
                                            Lainnya</option>
                                    </select>
                                    @error('category')
                                        <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea class="@error('description') is-invalid @enderror form-control mh-medium" id="description"
                                        name="description" placeholder="Tulis deskripsi..." required>{{ old('description', $product->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" class="@error('price') is-invalid @enderror form-control"
                                            ...
                                            value="@moneyFormatToNumeric(old('price', $product->price))" required>
                                        @error('price')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-2 offset-1 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="@error('discount') is-invalid @enderror form-control"
                            ...
                            <div class="form-row">
                                <div class="col-md-2 mb-3">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="text" class="@error('stock') is-invalid @enderror form-control"
                                            data-inputmask-alias="numeric" maxlength="5" id="stock" name="stock"
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="@error('disc_end') is-invalid @enderror form-control"
                                            data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy"
